...
namespace DigitalWorlds.StarterPackage2D
{
    ...
    public class CameraController2D : MonoBehaviour
    {
        ...
        [Tooltip("The input action used for peeking up and down.")]
        [SerializeField] private InputAction peekAction;
        ...
        [SerializeField] private ViewDestinationSettings viewDestinationSettings = new();

        private Coroutine cameraCoroutine;
        private Transform cachedTarget;
        private bool viewingDestination;
        private bool pauseFollowing;
        ...
        // Reset() is called when a component is first added to a GameObject in the editor
        private void Reset()
        {
            // Set up the default input action bindings
            peekAction = new InputAction("Peek", InputActionType.Value);
            peekAction.AddCompositeBinding("1DAxis")
        ...
        private void LateUpdate()
        {
            ...
            if (allowPeeking)
            {
                peekOffset = peekAction.ReadValue<float>();
            }
