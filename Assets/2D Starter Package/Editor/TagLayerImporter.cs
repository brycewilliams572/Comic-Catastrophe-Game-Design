...
namespace DigitalWorlds.StarterPackage2D
{
    ...
    {
        // Tags to be added
        private static readonly string[] requiredTags = { "Enemy" };
        ...
        const string IMPORT_KEY = "2DStarterPackage_ImportedTagsAndLayers_v2";

        static TagLayerImporter()
        {
            // Only import tags and layers if the user setting is true (i.e., already imported)
            if (EditorUserSettings.GetConfigValue(IMPORT_KEY) == "true")
            {
                return;
            }
        ...
        public static void SetupTagsAndLayers()
        {
            ...
            // Mark as imported
            EditorUserSettings.SetConfigValue(IMPORT_KEY, "true");
