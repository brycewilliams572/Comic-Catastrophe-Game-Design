...
namespace DigitalWorlds.StarterPackage2D
{
    ...
    public class Lock2D : MonoBehaviour
    {
        ...
        [Tooltip("The input action used for unlocking. Set to the E key by default.")]
        [SerializeField] private InputAction unlockAction = new("Unlock", InputActionType.Button, "<Keyboard>/e");
        ...
        private void Update()
        {
            if (unlockAction.WasPressedThisFrame() && requireButtonPress && inventory != null)
            {
                CheckUnlock();
            }
        }
