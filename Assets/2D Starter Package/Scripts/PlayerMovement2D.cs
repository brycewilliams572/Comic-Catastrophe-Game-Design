...
namespace DigitalWorlds.StarterPackage2D
{
    ...
    public class PlayerMovement2D : PlayerMovementBase
    {
        ...
        [Tooltip("The input action used for jumping. Set to the space bar by default.")]
        [SerializeField] protected InputAction jumpAction = new("Jump", InputActionType.Button, "<Keyboard>/space");
        ...
        protected virtual void FixedUpdate()
        {
            ...
            if (canMove)
            {
                // Get the horizontal axis from the move action
